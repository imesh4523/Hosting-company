      ...
      <div style={{
        ...
        <div style={{ padding: "20px 22px", flex: 1 }}>
          ...
          <div style={{ background: "#F9FAFB", borderRadius: "10px", padding: "14px", marginBottom: "20px" }}>
            <div style={{ fontSize: "11px", fontWeight: 700, color: "#9CA3AF", letterSpacing: "0.06em", marginBottom: "10px" }}>VPS INSTANCES: {server._count.vms}</div>
            <div style={{ display: "flex", gap: "12px" }}>
              {[
                { label: "Running",   count: Math.round(server._count.vms * 0.9), dot: "#10B981" },
                { label: "Stopped",   count: Math.round(server._count.vms * 0.07), dot: "#EF4444" },
                { label: "Suspended", count: Math.round(server._count.vms * 0.03), dot: "#F59E0B" },
              ].map((s, i) => (
