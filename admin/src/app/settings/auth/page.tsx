      ...
      <main style={{ flex: 1, padding: '30px 40px' }}>
        ...
        <div style={{ display: 'grid', gap: '24px' }}>
          ...
          <ProviderSection 
            ...
            onToggle={(v: boolean) => setSettings({...settings, googleEnabled: v})}
          ...
          <ProviderSection 
            ...
            onToggle={(v: boolean) => setSettings({...settings, facebookEnabled: v})}
          ...
          <ProviderSection 
            ...
            onToggle={(v: boolean) => setSettings({...settings, githubEnabled: v})}
