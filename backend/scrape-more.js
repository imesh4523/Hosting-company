...
(async () => {
    try {
        ...
        const subpages = [
            { name: 'addfunds', url: 'https://bill.youuhost.com/clientarea.php?action=addfunds' },
            { name: 'masspay', url: 'https://bill.youuhost.com/clientarea.php?action=masspay' },
            { name: 'tickets', url: 'https://bill.youuhost.com/clientarea.php?action=tickets' }
        ];
