...
html = html.replace(/"\/templates\//g, '"https://bill.ultahost.com/templates/');

// Fix relative root links starting with /assets/
html = html.replace(/"\/assets\//g, '"https://bill.ultahost.com/assets/');

// Fix missing protocols
html = html.replace(/"\/\/bill\.ultahost\.com/g, '"https://bill.ultahost.com');
