...
function cleanupFile(filePath) {
    ...
    content = content.replace(/https:\/\/bill\.youuhost\.com\/index\.php\/login\?language=english/ig, 'http://localhost:3000/login');
    ...
    content = content.replace(/https%3A%2F%2Fbill\.youuhost\.com/g, 'http://localhost:3000');
    content = content.replace(/bill\.youuhost\.com/g, 'localhost:3000');

    // Replace remaining youuhost.com
    content = content.replace(/https:\/\/youuhost\.com/g, 'http://localhost:3001');
    content = content.replace(/youuhost\.com/gi, 'localhost:3001');
