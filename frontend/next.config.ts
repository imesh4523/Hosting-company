...
const nextConfig: NextConfig = {
  async rewrites() {
    return [
      ...
      // ── External asset proxies (bill.ultahost.com) ─────────────────────────
      { source: '/templates/:path*',           destination: 'https://bill.ultahost.com/templates/:path*' },
      { source: '/assets/:path*',              destination: 'https://bill.ultahost.com/assets/:path*' },
      { source: '/dashboard/templates/:path*', destination: 'https://bill.ultahost.com/templates/:path*' },
