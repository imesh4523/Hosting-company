...
targetFiles.forEach(filePath => {
    ...
    content = content.replace(/https?:\/\/(www\.|bill\.)?ultahost\.com/gi, '');
    content = content.replace(/ultahost\.com/gi, 'localhost:3000');
    content = content.replace(/UltaHost/g, 'Hosting Company');
    content = content.replace(/ultahost/gi, 'hostingcompany');
